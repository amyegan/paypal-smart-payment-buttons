                        ...
                        return {
                            ...
                            onApprove: function(merchantData) {
                                return _onApprove({
                                    ...
                                    forceRestAPI: merchantData.forceRestAPI || !0
                                }, {
                                    restart: function() {
                            ...
                            upgradeFacilitatorAccessToken: function(facilitatorAccessToken, orderID) {
                                ...
                                if (!buyerAccessToken) throw new Error("Missing buyer access token");
                                auth_upgradeFacilitatorAccessToken(facilitatorAccessToken, {
                                    buyerAccessToken: buyerAccessToken,
                                    orderID: orderID
                                });
                            },
