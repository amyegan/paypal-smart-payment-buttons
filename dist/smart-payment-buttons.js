window.spb = function(modules) {
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        var session_buyerAccessToken = "defaultTokenValue";
                            ...
                            return function(_ref5) {
                                ...
                                return function(_ref16) {
                                    ...
                                    return callGraphQL({
                                        ...
                                        session_buyerAccessToken = approvePaymentWithNonce.buyer.auth.accessToken;
                                        return {
                                ...
                                return onApprove({
                                    ...
                                    buyerAccessToken: _ref8.buyerAccessToken
                                }, {
                                    restart: restart
                                });
                            }));
        ...
        function setupButton(opts) {
            ...
            var setupExportsTask = function(_ref) {
                ...
                var _createOrder = props.createOrder, _onApprove = props.onApprove, onError = props.onError, onCancel = props.onCancel, onClick = props.onClick, commit = props.commit, intent = props.intent, fundingSource = props.fundingSource, currency = props.currency, onAuth = props.onAuth;
                var fundingSources = querySelectorAll("[data-funding-source]").map((function(el) {
                    return el.getAttribute("data-funding-source");
                })).filter(Boolean);
                window.exports = {
                    ...
                    paymentSession: function() {
                        return {
                            ...
                            upgradeFacilitatorAccessToken: function(facilitatorAccessToken, orderID) {
                                ...
                                console.log("@@@ attempt token upgrade", {
                                    buyerAccessToken: buyerAccessToken,
                                    facilitatorAccessToken: facilitatorAccessToken,
                                    orderID: orderID
                                });
